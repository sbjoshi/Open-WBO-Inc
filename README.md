...
## Usage
Open-WBO-Inc can be used in the same way as Open-WBO. A description of the new features added in Open-WBO-Inc for incomplete MaxSAT solving is provided below.
