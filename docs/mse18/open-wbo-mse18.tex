...
\newcommand{\toolname}{Open-WBO-Inc\xspace}
...
% affiliations
\author{\IEEEauthorblockN{Saurabh Joshi$^\ddagger$, Prateek Kumar$^\ddagger$,Ruben Martins$^\dagger$, Sukrut Rao$^\ddagger$}
\IEEEauthorblockA{$^\ddagger$Indian Institute of Technology Hyderabad, India \\ $^\dagger$University of Texas at Austin / Carnegie Mellon University, USA }}
...
\toolname is developed on toop of Open-WBO\sjcomment{CITE},
...
solver~\cite{minisat-sat03}. However, for the purpose of this evaluation we are currently
using Glucose 4.1~\cite{audemard-ijcai09}. The key novelties of \toolname are: (i) a
...
\section{\toolname 2018: Incomplete Version}
